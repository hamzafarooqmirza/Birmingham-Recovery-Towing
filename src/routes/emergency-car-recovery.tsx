  ...
  return (
    <SiteLayout>
      <ServicePageTemplate
        ...
        benefits={["Live 24/7/365 emergency dispatch across Birmingham and West Midlands", "Fast response to your location across Birmingham and West Midlands", "Recovery trucks dispatched to your exact location", "Covers breakdowns, accidents and non-drivable vehicles", "Clear, upfront pricing before we roll out", "Professional, experienced recovery operators"]}
        why={[
        ...
        faqs={[
          ...
          { q: "How fast can you reach me in Birmingham?", a: "We aim to reach you as quickly as possible — response times vary by location and traffic conditions." },
