...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "24/7 emergency roadside assistance, vehicle recovery, jump start, battery replacement, mobile tyre service and secure vehicle storage across Ireland." },
      { name: "theme-color", content: "#0a0a14" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "T1T Towing & Recovery" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "T1T Towing & Recovery — 24/7 Roadside Assistance Ireland" },
      { name: "twitter:title", content: "T1T Towing & Recovery — 24/7 Roadside Assistance Ireland" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "T1T Towing & Recovery",
          telephone: "+353872521943",
          areaServed: "IE",
