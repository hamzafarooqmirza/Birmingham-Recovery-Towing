...
export const Route = createFileRoute("/luxury-exotic-car-towing")({
  head: () => ({
    meta: pageMeta({ title: "Luxury & Exotic Car Towing | Fast Recovery Pro", description: "Specialist towing for rare and exotic vehicles, planned individually around each model's needs.", path: "/luxury-exotic-car-towing", image: IMG.tow4 }),
...
function LuxuryExoticCarTowing() {
  return (
    <SiteLayout>
      <ServicePageTemplate
        eyebrow="Service" title="Luxury & Exotic Car Towing (سحب السيارات الفاخرة والنادرة)" hero={IMG.tow4}
